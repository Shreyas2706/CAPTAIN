...
const captain_t = document.getElementById('captain_t'); // Select the element to display captain' speech output
...
var numStars = 2000; // Increased number of stars
var stars = [];
...
function speak(text) {
    ...
    captain_t.textContent = text; // Display the spoken text in the designated element
...
async function processCommand(message) {
    ...
    // Respond to inquiries about its identity
		...
		finalText = 'I am captain an artificial intelligence designed by shreyas to be his personal assistant and manage his Server.';
    }
	
    // Identify the user
    else if (message.includes('do you know who am i') || message.includes('who am i')) {
        finalText = "In reality you are my boss, shreyas.";
    }
	...
	// Open github in a new tab
        ...
        window.open("https://shreyas.com", "_blank");
    ...
    // General questions
        ...
        finalText = `shreyas was the one who gave me life.`;
    }
	// Birthday
    else if (message.includes('when is your birthday')) {
        finalText = `On April 4 2024 around midnight I existed as an idea in shreyas's mind.`;
    }
    ...
    // Handle a command to set a timer
        ...
        setTimeout(() => {
            ...
            captain_t.textContent = speech.text;
	...
	speech.text = finalText;
	captain_t.textContent = speech.text; // Display text spoken by captain in the designated element
